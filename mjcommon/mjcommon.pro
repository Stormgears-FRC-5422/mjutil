...
win32:PreBuildEvent.commands = ..\..\mjutil\mjcommon\update_version.bat %cd%\..\..\mjutil\mjcommon
!win32:PreBuildEvent.commands = ../../mjutil/mjcommon/update_version.sh ${PWD}/../../mjutil/mjcommon
